...
<head>
	...
	<link rel="stylesheet" media="screen,projection" type="text/css" href="{SITEURL}/css/jquery-ui.css">
	...
	<link rel="stylesheet" type="text/css" href="{SITEURL}themes/{THEME}/css/style_responsive.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a href="index.php" alt="{L_166}">{L_166}</a></li>
						...
						<li><a href="maintainance.php" alt="{L_5436}">{L_5436}</a></li>
