...
<link rel="stylesheet" type="text/css" href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>themes/<?php echo (isset($this->_rootref['THEME'])) ? $this->_rootref['THEME'] : ''; ?>/slick/slick.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>themes/<?php echo (isset($this->_rootref['THEME'])) ? $this->_rootref['THEME'] : ''; ?>/slick/slick-theme.css"/>
				
</head>
<body>
<div class="container">
	<div class="row header">
		<div class="col-md-4"><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>uploaded/logo/<?php echo (isset($this->_rootref['LOGO'])) ? $this->_rootref['LOGO'] : ''; ?>" border="0" alt="<?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>"></a></div>
		<div class="col-md-6 hidden-xs text-center"><?php echo (isset($this->_rootref['BANNER'])) ? $this->_rootref['BANNER'] : ''; ?></div>
	</div>
	<div class="row">
		<div class="col-md-6 text-muted hello">&nbsp;&nbsp;&nbsp;&nbsp;<small><?php if ($this->_rootref['B_LOGGED_IN']) {  echo ((isset($this->_rootref['L_200'])) ? $this->_rootref['L_200'] : ((isset($MSG['200'])) ? $MSG['200'] : '{ L_200 }')); ?> <?php echo (isset($this->_rootref['YOURUSERNAME'])) ? $this->_rootref['YOURUSERNAME'] : ''; ?>. <a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>logout.php?"><?php echo ((isset($this->_rootref['L_245'])) ? $this->_rootref['L_245'] : ((isset($MSG['245'])) ? $MSG['245'] : '{ L_245 }')); ?></a><?php } ?></small></div>
...
background-image: -moz-linear-gradient(top,#09C6E6,#3196ED);
background-image: -webkit-gradient(linear,0 0,0 100%,from(#09C6E6),to(#3196ED));
background-image: -webkit-linear-gradient(top,#09C6E6,#3196ED);
background-image: -o-linear-gradient(top,#09C6E6,#3196ED);
background-image: linear-gradient(to bottom,#09C6E6,#3196ED);
background-repeat: repeat-x;
-webkit-border-radius: 4px;
-moz-border-radius: 4px;
border-radius: 4px;
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#09C6E6',endColorstr='#3196ED',GradientType=0);
*zoom: 1;
				...
				<div class="form-group">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button type="submit" class="btn btn-primary" name="sub" value="search"><?php echo ((isset($this->_rootref['L_399'])) ? $this->_rootref['L_399'] : ((isset($MSG['399'])) ? $MSG['399'] : '{ L_399 }')); ?></button>
						</span>
					</div>
				</div>
