<ul class="list-group">
					...
					<li class="list-group-item"><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/enablefees.php"><?php echo ((isset($this->_rootref['L_395'])) ? $this->_rootref['L_395'] : ((isset($MSG['395'])) ? $MSG['395'] : '{ L_395 }')); ?></a></li>
					...
					<li class="list-group-item"><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/invoice_settings.php"><?php echo ((isset($this->_rootref['L_1094'])) ? $this->_rootref['L_1094'] : ((isset($MSG['1094'])) ? $MSG['1094'] : '{ L_1094 }')); ?></a></li>
					...
					<li class="list-group-item"><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>admin/tax.php"><?php echo ((isset($this->_rootref['L_1088'])) ? $this->_rootref['L_1088'] : ((isset($MSG['1088'])) ? $MSG['1088'] : '{ L_1088 }')); ?></a></li>
