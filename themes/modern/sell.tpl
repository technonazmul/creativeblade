					...
					function listIn(id){
						...
						if(id=='3') {
						   $('#atype').val(1);
						    ...
						    document.getElementById("bn_yes").checked = true;
						    document.getElementById("bn_no").checked = false;
						   ...
						   $('#atype').val(id);	
							...
							document.getElementById("bn_yes").checked = false;
						    document.getElementById("bn_no").checked = true;
...
<!-- IF PAGE eq 0 -->
	...
	<!-- ENDIF -->
					...
					<input id="atype" name="atype" value="{LISTING_TYPE}" type="hidden">
				    <input id="buyin" name="buy_now_only" value="{BUY_NOW_ONLY_CHECKED}" type="hidden">
					<div class="form-group col-md-12">
						<label for="atypein">{L_257}</label>
						<div class="row">
							<div class="auctiontype col-md-4">
							      {SELECT_TYPE}
					...
					<div class="form-group col-md-12" id="iqty_div" >
						<label for="iquantity">{L_258}</label>
						<div class="row">
							<div class="col-md-4">
								<input type="text" name="iquantity" id="iqty" class="form-control" value="{ITEMQTY}" >
							</div>
						</div>
					</div>
					<div class="form-group col-md-12" id="min_bid_div">
	...
	<!-- ENDIF -->
	<!-- IF B_BN -->
					<div class="form-group col-md-12" id="buy_now_div" >
						<label>{L_496}</label>
						<div class="radio" id="buy_now_radio">
							<label class="radio-inline">
