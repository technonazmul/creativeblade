...
<!-- ENDIF -->
     ...
     <form name="upldbanner" action="" method="post" enctype="multipart/form-data"><br>
                    <table class="table table-bordered table-condense table-striped"  cellpadding="0" cellspacing="0">
                    <tr>
...
<!-- END banners -->
                    ...
                    <input type="submit" name="act" class="btn btn-primary" value="{L__0040}">
                    <!-- ENDIF -->
                    <!-- IF B_EXBANNER_PAID -->
                    <input type="hidden" name="action" value="insert">
                    <input type="submit" name="act" class="btn btn-primary" value="{L__0040}">
