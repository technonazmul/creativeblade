			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="featured-item">
					<div class="item-ads-grid">
						<div class="img-grid">
							<div class="item-meta">
						<a href="{SITEURL}item.php?id={featured.ID}"><img class="img-center" src="{featured.IMAGE}" height="150px" ></a>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="featured-item">
					<div class="item-ads-grid">
						<div class="img-grid">
							<div class="item-meta">
								<a href="{SITEURL}item.php?id={hotitems.ID}"><img class="img-center" src="{hotitems.IMAGE}" height="150px"></a>
     ...
     <div class="col-md-4 col-sm-4 col-xs-12">
				<div class="featured-item">
					<div class="item-ads-grid">
						<div class="img-grid">
							<div class="item-meta">
								<a href="{SITEURL}item.php?id={auc_last.ID}"><img class="img-center" src="{auc_last.IMAGE}" height="150px"></a>
								<div class="feat-title"><h4><a href="{SITEURL}item.php?id={auc_last.ID}">{auc_last.TITLE}</a></h4></div>
								<div class="grid-margin-btm-lg">
									<small><span class="text-muted"><span class="glyphicon glyphicon-time" aria-hidden="true"></span>  {auc_last.DATE}</span></small>
								</div>
							</div>
