...
<div class="container">
	<div class="row header">
		<div class="col-md-4"><a href="{SITEURL}"><img src="{SITEURL}uploaded/logo/{LOGO}" border="0" alt="{SITENAME}"></a></div>
		<div class="col-md-6 hidden-xs text-center">{BANNER}</div>
	</div>
	<div class="row">
		<div class="col-md-6 text-muted hello">&nbsp;&nbsp;&nbsp;&nbsp;<small><!-- IF B_LOGGED_IN -->{L_200} {YOURUSERNAME}. <a href="{SITEURL}logout.php?">{L_245}</a><!-- ENDIF --></small></div>
				...
				<div class="form-group">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button type="submit" class="btn btn-primary" name="sub" value="search">{L_399}</button>
						</span>
					</div>
				</div>
